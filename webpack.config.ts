...
// Polyfill: import.meta.dirname may be undefined when loaded via CJS transpilers (tsx/esbuild-register)
if (!import.meta.dirname) {
  (import.meta as any).dirname = typeof __dirname !== 'undefined' ? __dirname : path.dirname(fileURLToPath(import.meta.url));
}
